...
should_return_expected_value_when_args_match() ->
    hoax_tab:init_expect( ?EXPECT(f,[1,2], {return,a_result}) ),
...
should_return_discrete_expected_values_for_appropriate_args_regardless_of_call_order() ->
    hoax_tab:init_expect(?EXPECT(f,[1,2], {return,result_for_args_1_and_2})),
    hoax_tab:init_expect(?EXPECT(f,[3,4], {return,result_for_args_3_and_4})),
    hoax_module:compile(m, ?EXPORTS),
