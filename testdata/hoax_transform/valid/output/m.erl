...
hoax_syntax_examples() ->
    ...
    hoax:test(fun () ->
		      ...
		      hoax:expect([{expectation, {module, function, 1}, [one], [], fun (one) -> arbitrary_return_value end, 0,
				    undefined},
				   {expectation, {module, function, 2}, [V1, V2], [], fun (V1, V2) -> error(some_error) end, 0,
				    undefined}])
	      end).